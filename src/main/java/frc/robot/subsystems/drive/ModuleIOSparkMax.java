  ...
  public ModuleIOSparkMax(int index) {
    switch (index) {
      case 0:
        ...
        absoluteEncoderOffset = new Rotation2d(1.445); // MUST BE CALIBRATED
        break;
      case 1:
        ...
        absoluteEncoderOffset = new Rotation2d(5.601); // MUST BE CALIBRATED
        break;
      case 2:
        driveSparkMax = new CANSparkMax(3, MotorType.kBrushless);
        turnSparkMax = new CANSparkMax(1, MotorType.kBrushless);
        turnAbsoluteEncoder = new CANcoder(2);
        absoluteEncoderOffset = new Rotation2d(2.715); // MUST BE CALIBRATED
        break;
      case 3:
        ...
        absoluteEncoderOffset = new Rotation2d(1.73); // MUST BE CALIBRATED
        break;
      default:
